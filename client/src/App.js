...
import { faPause, faStop, faArrowUpRightFromSquare, faArrowsRotate, faTrash } from '@fortawesome/free-solid-svg-icons'
                                    ...
                                    <Card className="printer-state">
                                        ...
                                        <ListGroup className="list-group-flush">
                                            ...
                                            <ListGroup.Item>
                                                ...
                                                Job ID: <b>12341234</b> <br />
                                                Job Status: <b>Running</b>
                                            </ListGroup.Item>
                                            <ListGroup.Item>
                                                <div>
                                        ...
                                        <ListGroup className="list-group-flush">
                                            <ListGroup.Item>
                                                ...
                                                <Form.Group controlId="formFile" className="mb-3">
                                                    ...
                                                    <Form.Control accept=".gcode,.data" type="file" />
                                                </Form.Group>
                                                {/* </Tab> */}
                                                {/* <Tab eventKey="existing" title="Local File">
                                                        ...
                                                        <ListGroup variant="flush">
                                                            <ListGroup.Item action variant="light" style={{ display: "flex" }}>asldkfasdf.gcode
                                                                <FontAwesomeIcon icon={faTrash}
                                                                    style={{ marginLeft: "auto" }} />
                                                            </ListGroup.Item>
                                                            <ListGroup.Item action variant="light" style={{ display: "flex" }}>asdfkasdfl.gcode
                                                                <FontAwesomeIcon icon={faTrash}
                                                                    style={{ marginLeft: "auto" }} />
                                                            </ListGroup.Item>
                                                            <ListGroup.Item action variant="light" style={{ display: "flex" }}>asldfsladfdsa.gcode
                                                                <FontAwesomeIcon icon={faTrash}
                                                                    style={{ marginLeft: "auto" }} />
                                                            </ListGroup.Item>
                                                            <ListGroup.Item action variant="light" style={{ display: "flex" }}>bed.gcode
                                                                <FontAwesomeIcon icon={faTrash}
                                                                    style={{ marginLeft: "auto" }} />
                                                            </ListGroup.Item>
                                                        </ListGroup>
                                            ...
                                            <Row className="mb-2">
                                                ...
                                                <Col xs="4">
                                                    <Card className="modal-card" bg="light">
                                                        ...
                                                        <span>Username: <b>Jakob</b></span>
                                                        <span>Password: <b>Jakob</b></span>
